...
df_noRave = df[(df["ravePlayerTwo"] == False)]
df["budgetRatio"] = df["budgetPlayer1"] / df["budgetPlayer2"] 

budgets, win_rates_p2, win_rates_rave, win_rates_no_rave = compute_moving_average(df, df_rave, df_noRave, "budgetPlayer2", "winner", percentage=10)
