...
def compute_moving_average(data, data_rave, data_no_rave, budget_column, winner_column, percentage=10):
    ...
    """
    Calcule le taux de victoire moyen pour un joueur en fonction du rapport de budget,
    ...
    for budget in unique_budgets:
        ...
        if len(window) > 0:
            win_rate_p2 = (window[winner_column] == 1).mean()
        else:
            win_rate_p2 = 0
...
df_rave["budgetRatio"] = df_rave["budgetPlayer1"] / df_rave["budgetPlayer2"]
df_noRave["budgetRatio"] = df_noRave["budgetPlayer1"] / df_noRave["budgetPlayer2"]
